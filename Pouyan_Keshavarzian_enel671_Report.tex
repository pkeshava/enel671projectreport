...
at $m = 0$. These are adjusted to 1, and 2 more Matlab indexing purposes. Prediction and estimation are combined into one stage for implementation
...
and the hardware reseource that would be required in real-time implemenation it is not practical to use this algorithm.
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering,font = small}
...
increase back to a congerging value of 1. This is confirmed by Figure ~\ref{fig:likelihood}
\begin{figure}[H]
  \centering
  \captionsetup{justification=centering,font = small}
