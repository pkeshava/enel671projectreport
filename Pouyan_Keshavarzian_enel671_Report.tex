...
with $M = 11, \qquad \delta = 0.01 \qquad SNR = 40dB$ where,  $\delta$ is a parameter is for implementation
...
converge even with a high filter order. This is demonstrated in Figure ~\ref{fig:filterorder2}. As opposed to the
