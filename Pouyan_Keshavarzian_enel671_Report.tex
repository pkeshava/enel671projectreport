...
performance advantages in terms of convergence speed at the cost of a significant increase in complexity.
\end{abstract}
...
such use case is for adaptive equalization. That is to remove unwanted signals from
the channel output which can be caused by multipath or other distortions
